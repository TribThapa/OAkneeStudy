...
matlabbatch{1}.spm.stats.fmri_spec.dir = {['/../../', subID{i},'/Cing_R/']};
...
for j = 1:300
        ...
        Rest(j) = {['/../../',subID{i},'/',subID{i},'_bold.nii,',num2str(j)]};
end
...
matlabbatch{1}.spm.stats.fmri_spec.sess.multi_reg = {['/../../',subID{i},'/',subID{i},'_Cing_R_WMCSFXYZrots.txt']};
